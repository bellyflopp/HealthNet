...
from HealthNet.static.reportlab.platypus.flowables import *
...
from HealthNet.static.reportlab.rl_config import defaultPageSize, verbose
import HealthNet.static.reportlab.lib.sequencer
from HealthNet.static.reportlab.pdfgen import canvas
from HealthNet.static.reportlab.lib.utils import isSeq, encode_label, decode_label, annotateException, strTypes
...
def _evalMeasurement(n):
    if isinstance(n,str):
        from HealthNet.static.reportlab.platypus.paraparser import _num
        n = _num(n)
        if isSeq(n): n = n[1]
    return n
...
class BaseDocTemplate:
    ...
    def _startBuild(self, filename=None, canvasmaker=canvas.Canvas):
        ...
        self.seq = HealthNet.static.reportlab.lib.sequencer.Sequencer()
...
if __name__ == '__main__':
    from HealthNet.static.reportlab.lib.styles import _baseFontName, _baseFontNameB
    def myFirstPage(canvas, doc):
        from HealthNet.static.reportlab.lib.colors import red
    ...
    def run():
        ...
        from HealthNet.static.reportlab.platypus.doctemplate import SimpleDocTemplate

        #need a style
        normal = ParagraphStyle('normal')
        normal.firstLineIndent = 18
        normal.spaceBefore = 6
        from HealthNet.static.reportlab.lib.randomtext import randomText
        import random
        for i in range(15):
