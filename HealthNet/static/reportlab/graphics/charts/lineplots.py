...
from HealthNet.static.reportlab.lib import colors
from HealthNet.static.reportlab.lib.validators import *
from HealthNet.static.reportlab.lib.attrmap import *
from HealthNet.static.reportlab.graphics.shapes import Drawing, Group, Rect, Line, PolyLine, Polygon, _SetKeyWordArgs
from HealthNet.static.reportlab.graphics.widgetbase import Widget, TypedPropertyCollection, PropHolder
from HealthNet.static.reportlab.graphics.charts.textlabels import Label
from HealthNet.static.reportlab.graphics.charts.axes import XValueAxis, YValueAxis, AdjYValueAxis, NormalDateXValueAxis
from HealthNet.static.reportlab.graphics.charts.utils import *
from HealthNet.static.reportlab.graphics.widgets.markers import uSymbol2Symbol, isSymbol, makeMarker
from HealthNet.static.reportlab.graphics.widgets.grids import Grid, DoubleGrid, ShadedRect, ShadedPolygon
from HealthNet.static.reportlab.pdfbase.pdfmetrics import stringWidth, getFont
from HealthNet.static.reportlab.graphics.charts.areas import PlotArea
...
from HealthNet.static.reportlab.graphics.charts.linecharts import AbstractLineChart
class LinePlot(AbstractLineChart):
    ...
    def addCrossHair(self,name,xv,yv,strokeColor=colors.black,strokeWidth=1,beforeLines=True):
        from HealthNet.static.reportlab.graphics.shapes import Group, Line
...
class LinePlot3D(LinePlot):
    ...
    def makeLines(self):
        ...
        from HealthNet.static.reportlab.graphics.charts.linecharts import _FakeGroup
        F = _FakeGroup()

        from HealthNet.static.reportlab.graphics.charts.utils3d import _make_3d_line_info, find_intersections
        if self.xValueAxis.style!='parallel_3d':
