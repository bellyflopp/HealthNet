...
from HealthNet.static.reportlab.graphics import shapes
...
class PropHolder:
    ...
    def getProperties(self,recur=1):
        ...
        from HealthNet.static.reportlab.lib.validators import isValidChild
...
def test():
    from HealthNet.static.reportlab.graphics.charts.piecharts import WedgeProperties
    wedges = TypedPropertyCollection(WedgeProperties)
