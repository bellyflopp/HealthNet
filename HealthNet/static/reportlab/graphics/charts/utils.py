...
import weakref
from HealthNet.static.reportlab.graphics.shapes import transformPoint, transformPoints, inverse, Ellipse, Group, String, Path, numericXShift
from HealthNet.static.reportlab.lib.utils import flatten
