...
from HealthNet.static.reportlab.lib.validators import isNumber, isNumberOrNone, isColor, isColorOrNone, isListOfStrings, \
...
from HealthNet.static.reportlab.graphics.shapes import Line, Rect, Group, Drawing, Polygon, PolyLine
from HealthNet.static.reportlab.graphics.widgets.signsandsymbols import NoEntry
from HealthNet.static.reportlab.graphics.charts.axes import XCategoryAxis, YValueAxis
...
class HorizontalLineChart3D(HorizontalLineChart):
    ...
    def makeLines(self):
        ...
        F = _FakeGroup()
        from HealthNet.static.reportlab.graphics.charts.utils3d import _make_3d_line_info
