...
from HealthNet.static.reportlab.pdfbase.pdfmetrics import stringWidth, getFont, getAscentDescent
from HealthNet.static.reportlab.platypus.paraparser import ParaParser
from HealthNet.static.reportlab.platypus.flowables import Flowable
from HealthNet.static.reportlab.lib.colors import Color
from HealthNet.static.reportlab.lib.enums import TA_LEFT, TA_RIGHT, TA_CENTER, TA_JUSTIFY
from HealthNet.static.reportlab.lib.geomutils import normalizeTRBL
from HealthNet.static.reportlab.lib.textsplit import wordSplit, ALL_CANNOT_START
from copy import deepcopy
from HealthNet.static.reportlab.lib.abag import ABag
from HealthNet.static.reportlab.rl_config import platypus_link_underline, decimalSymbol, _FUZZ, paraFontSizeHeightOffset
from HealthNet.static.reportlab.lib.utils import _className, isBytes, unicodeT, bytesT, strTypes
from HealthNet.static.reportlab.lib.rl_accel import sameFrag
import re
...
class Paragraph(Flowable):
    ...
    def breakLinesCJK(self, maxWidths):
        ...
        if nFrags==1 and not hasattr(frags[0],'cbDefn') and not style.endDots:
            ...
            from HealthNet.static.reportlab.lib.textsplit import wordSplit
...
if __name__=='__main__':    #NORUNTESTS
    ...
    from HealthNet.static.reportlab.lib.styles import getSampleStyleSheet, ParagraphStyle
    from HealthNet.static.reportlab.lib.units import cm
    import sys
    TESTS = sys.argv[1:]
    if TESTS==[]: TESTS=['4']
