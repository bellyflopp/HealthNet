...
from HealthNet.static.reportlab.lib.validators import isNumber, isNumberOrNone, isColor, isColorOrNone, isString,\
            isListOfStrings, SequenceOf, isBoolean, isNoneOrShape, isStringOrNone,\
            NoneOr, isListOfNumbersOrNone, EitherOr, OneOf
from HealthNet.static.reportlab.graphics.widgets.markers import uSymbol2Symbol, isSymbol
from HealthNet.static.reportlab.lib.formatters import Formatter
from HealthNet.static.reportlab.lib.attrmap import AttrMap, AttrMapValue
...
from HealthNet.static.reportlab.graphics.shapes import Line, Rect, Group, Drawing, NotImplementedError
from HealthNet.static.reportlab.graphics.charts.axes import XCategoryAxis, YValueAxis, YCategoryAxis, XValueAxis
from HealthNet.static.reportlab.graphics.charts.textlabels import BarChartLabel, NA_Label, NoneOrInstanceOfNA_Label
from HealthNet.static.reportlab.graphics.charts.areas import PlotArea
from HealthNet.static.reportlab.graphics.charts.legends import _objStr
...
class BarChart3D(BarChart):
    ...
    def makeBars(self):
        from HealthNet.static.reportlab.graphics.charts.utils3d import _draw_3d_bar
