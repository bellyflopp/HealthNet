...
from HealthNet.static.reportlab.graphics.shapes import definePath, Group, Drawing, Rect, PolyLine, String
from HealthNet.static.reportlab.graphics.widgetbase import Widget
from HealthNet.static.reportlab.lib.colors import Color, black, white, ReportLabBlue
