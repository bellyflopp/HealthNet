...
from HealthNet.static.reportlab.graphics.shapes import Line, Rect, Polygon, Drawing, Group, String, Circle, Wedge
...
from HealthNet.static.reportlab.graphics.widgets.signsandsymbols import _Symbol
import copy
