...
from HealthNet.static.reportlab.lib import enums
from HealthNet.static.reportlab.lib.units import cm
from HealthNet.static.reportlab.lib.utils import commasplit, escapeOnce, encode_label, decode_label, strTypes, asUnicode
from HealthNet.static.reportlab.lib.styles import ParagraphStyle, _baseFontName
from HealthNet.static.reportlab.platypus.paragraph import Paragraph
from HealthNet.static.reportlab.platypus.doctemplate import IndexingFlowable
from HealthNet.static.reportlab.platypus.tables import TableStyle, Table
from HealthNet.static.reportlab.platypus.flowables import Spacer, Flowable
...
class SimpleIndex(IndexingFlowable):
    ...
    def setup(self, style=None, dot=None, tableStyle=None, headers=True, name=None, format='123', offset=0):
        ...
        if name is None:
            from HealthNet.static.reportlab.platypus.paraparser import DEFAULT_INDEX_NAME as name
        self.name = name
