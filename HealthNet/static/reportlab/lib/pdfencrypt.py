...
from HealthNet.static.reportlab.lib.utils import getBytesIO, md5, asBytes, int2Byte, char2int, rawUnicode, rawBytes, isPy3
from HealthNet.static.reportlab.pdfgen.canvas import Canvas
from HealthNet.static.reportlab.pdfbase import pdfutils
from HealthNet.static.reportlab.pdfbase.pdfdoc import PDFObject
...
class StandardEncryptionDictionary(PDFObject):
    ...
    def format(self, document):
        ...
        from HealthNet.static.reportlab.pdfbase.pdfdoc import DummyDoc, PDFDictionary, PDFString, PDFName
        dummy = DummyDoc()
...
def computeO(userPassword, ownerPassword, revision):
    from HealthNet.static.reportlab.lib.arciv import ArcIV
