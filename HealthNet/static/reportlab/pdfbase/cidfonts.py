...
import HealthNet.static.reportlab
from HealthNet.static.reportlab.pdfbase import pdfmetrics
from HealthNet.static.reportlab.pdfbase._cidfontdata import allowedTypeFaces, allowedEncodings, CIDFontInfo, \
...
from HealthNet.static.reportlab.lib.rl_accel import escapePDF
from HealthNet.static.reportlab.rl_config import CMapSearchPath
from HealthNet.static.reportlab.lib.utils import isSeq, isBytes
...
class CIDEncoding(pdfmetrics.Encoding):
    ...
    def __init__(self, name, useCache=1):
        ...
        if not DISABLE_CMAP:
            if useCache:
                from HealthNet.static.reportlab.lib.utils import get_rl_tempdir
...
if __name__=='__main__':
    import doctest
    from HealthNet.static.reportlab.pdfbase import cidfonts
