...
from HealthNet.static.reportlab.lib.validators import    isNumber, isNumberOrNone, isListOfStringsOrNone, isListOfNumbers, \
...
from HealthNet.static.reportlab.lib import normalDate
from HealthNet.static.reportlab.graphics.shapes import Drawing, Line, PolyLine, Rect, Group, STATE_DEFAULTS, _textBoxLimits, _rotatedBoxLimits
from HealthNet.static.reportlab.graphics.widgetbase import Widget, TypedPropertyCollection
from HealthNet.static.reportlab.graphics.charts.textlabels import Label, PMVLabel
from HealthNet.static.reportlab.graphics.charts.utils import nextRoundNumber
...
from HealthNet.static.reportlab.lib.utils import isSeq
import copy
try:
    reduce  # Python 2.x
except NameError:
...
class AdjYValueAxis(YValueAxis):
    ...
    def _rangeAdjust(self):
        ...
        from HealthNet.static.reportlab.graphics.charts.utils import find_good_grid, ticks
...
def sample1():
    ...
    from HealthNet.static.reportlab.graphics.shapes import _baseGFontNameB
    drawing = Drawing(400, 200)
    data = [(10, 20, 30, 42)]
    xAxis = XCategoryAxis()
    xAxis.setPosition(75, 75, 300)
