...
from HealthNet.static.reportlab.rl_config import _FUZZ
from HealthNet.static.reportlab.lib.utils import isUnicode
...
def getCharWidths(word, fontName, fontSize):
    ...
    [6.0, 6.0, 6.0, 6.0, 6.0]
    >>> from HealthNet.static.reportlab.pdfbase.cidfonts import UnicodeCIDFont
    >>> from HealthNet.static.reportlab.pdfbase.pdfmetrics import registerFont
...
if __name__=='__main__':
    import doctest
    from HealthNet.static.reportlab.lib import textsplit
