...
HealthNet.static.reportlab._rl_testing=True
del HealthNet.static.reportlab
__version__='3.3.0'
...
try:
    ...
    from ConfigParser import ConfigParser
import unittest
from HealthNet.static.reportlab.lib.utils import isCompactDistro, __loader__, rl_isdir, asUnicode
...
def setOutDir(name):
    ...
    import HealthNet.static.reportlab
    RL_HOME=HealthNet.static.reportlab.__path__[0]
