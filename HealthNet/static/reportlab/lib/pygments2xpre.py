...
from HealthNet.static.reportlab.lib.utils import isPy3, asBytes, getBytesIO, getStringIO, asUnicode, isUnicode
...
def convertSourceFiles(filenames):
    ...
    from HealthNet.static.reportlab.platypus.xpreformatted import XPreformatted
