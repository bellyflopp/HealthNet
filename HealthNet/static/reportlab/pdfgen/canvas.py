...
from HealthNet.static.reportlab import rl_config
from HealthNet.static.reportlab.pdfbase import pdfutils
from HealthNet.static.reportlab.pdfbase import pdfdoc
from HealthNet.static.reportlab.pdfbase import pdfmetrics
from HealthNet.static.reportlab.pdfgen  import pdfgeom, pathobject, textobject
from HealthNet.static.reportlab.lib.colors import black, _chooseEnforceColorSpace, Color, CMYKColor, toColor
from HealthNet.static.reportlab.lib.utils import import_zlib, ImageReader, isSeq, isStr, isUnicode, _digester
from HealthNet.static.reportlab.lib.rl_accel import fp_str, escapePDF
from HealthNet.static.reportlab.lib.boxstuff import aspectRatioFix
...
def _annFormat(D,color,thickness,dashArray,hradius=0,vradius=0):
    from HealthNet.static.reportlab.pdfbase.pdfdoc import PDFArray, PDFDictionary
...
def _buildColorFunction(colors, positions):
    from HealthNet.static.reportlab.pdfbase.pdfdoc import PDFExponentialFunction, PDFStitchingFunction
...
class Canvas(textobject._PDFColorSetter):
    ...
    def setEncrypt(self, encrypt):
        ...
        '''
        if encrypt:
            from HealthNet.static.reportlab.lib import pdfencrypt
    ...
    def drawInlineImage(self, image, x,y, width=None,height=None,
        ...
        from HealthNet.static.reportlab.pdfgen.pdfimages import PDFImage
    ...
    def linkURL(self, url, rect, relative=0, thickness=0, color=None, dashArray=None, kind="URI", **kw):
        ...
        from HealthNet.static.reportlab.pdfbase.pdfdoc import PDFDictionary, PDFName, PDFArray, PDFString
    ...
    def linearGradient(self, x0, y0, x1, y1, colors, positions=None, extend=True):
        ...
        from HealthNet.static.reportlab.pdfbase.pdfdoc import PDFAxialShading
    ...
    def radialGradient(self, x, y, radius, colors, positions=None, extend=True):
        #this code contributed by Peter Johnson <johnson.peter@gmail.com>
        from HealthNet.static.reportlab.pdfbase.pdfdoc import PDFRadialShading
        colorSpace, ncolors = _normalizeColors(colors)
        fcn = _buildColorFunction(ncolors, positions)
        if extend:
            extendStr = "[true true]"
    ...
    def setViewerPreference(self,pref,value):
        ...
        if VP is None:
            from HealthNet.static.reportlab.pdfbase.pdfdoc import ViewerPreferencesPDFDictionary
    ...
    def setCatalogEntry(self,key,value):
        from HealthNet.static.reportlab.pdfbase.pdfdoc import PDFDictionary, PDFArray, PDFString
        if isStr(value):
    ...
    def addPageLabel(self, pageNum, style=None, start=None, prefix=None):
        ...
        if PL is None:
            from HealthNet.static.reportlab.pdfbase.pdfdoc import PDFPageLabels
            PL = catalog.PageLabels = PDFPageLabels()

        from HealthNet.static.reportlab.pdfbase.pdfdoc import PDFPageLabel
