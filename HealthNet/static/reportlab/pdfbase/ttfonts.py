...
from HealthNet.static.reportlab.lib.utils import getBytesIO, isPy3, bytestr, isUnicode, char2int
from HealthNet.static.reportlab.pdfbase import pdfmetrics, pdfdoc
from HealthNet.static.reportlab import rl_config
from HealthNet.static.reportlab.lib.rl_accel import hex32, add32, calcChecksum, instanceStringWidthTTF
...
def TTFOpenFile(fn):
    ...
    '''
    from HealthNet.static.reportlab.lib.utils import rl_isfile, open_for_read
    try:
