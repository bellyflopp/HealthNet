...
from HealthNet.static.reportlab.pdfbase.pdfmetrics import stringWidth # for font info
from HealthNet.static.reportlab.lib.rl_accel import fp_str
from HealthNet.static.reportlab.lib.colors import black
from HealthNet.static.reportlab.lib.utils import asNative
from HealthNet.static.reportlab.graphics.renderbase import StateTracker, getStateDelta, Renderer, renderScaledDrawing
from HealthNet.static.reportlab.graphics.shapes import STATE_DEFAULTS, Path, UserNode
from HealthNet.static.reportlab.graphics.shapes import * # (only for test0)
from HealthNet.static.reportlab import rl_config
from HealthNet.static.reportlab.lib.utils import getBytesIO, RLString, isPy3, isUnicode, isBytes
...
class _SVGRenderer(Renderer):
    ...
    def drawPath(self, path):
        ...
        from HealthNet.static.reportlab.graphics.shapes import _renderPath
        c = self._canvas
...
def test(outDir='out-svg'):
    ...
    from HealthNet.static.reportlab.graphics import testshapes
    drawings = []
    ...
    from HealthNet.static.reportlab.graphics.testshapes import getDrawing01
    d = getDrawing01()
    drawToFile(d, os.path.join(outDir,"test.svg"))

    from HealthNet.static.reportlab.lib.corp import RL_CorpLogo
    from HealthNet.static.reportlab.graphics.shapes import Drawing
