...
from HealthNet.static.reportlab.lib.utils import pickle
...
from HealthNet.static.reportlab.lib.utils import rl_isdir, rl_isfile, rl_listdir, rl_getmtime
class FontFinder:
    ...
    def _getCacheFileName(self):
        ...
        from HealthNet.static.reportlab.lib.utils import get_rl_tempfile
            ...
            for fileName in fileNames:
                ...
                if ext.lower() in EXTENSIONS:
                    ...
                    if ext in ('otf', 'pfa'):
                        ...
                        from HealthNet.static.reportlab.pdfbase.ttfonts import TTFontFile, TTFError
                        try:
                        ...
                        if rl_isfile(os.path.join(dirName, root + '.afm')):
                            ...
                            self._skippedFiles.append(fileName)
                            continue
                        from HealthNet.static.reportlab.pdfbase.pdfmetrics import parseAFMFile
...
def test():
    ...
    rlFontDir = os.path.join(os.path.dirname(HealthNet.static.reportlab.__file__), 'fonts')
