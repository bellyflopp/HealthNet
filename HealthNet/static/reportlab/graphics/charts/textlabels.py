...
from HealthNet.static.reportlab.lib.utils import simpleSplit, _simpleSplit
from HealthNet.static.reportlab.lib.validators import isNumber, isNumberOrNone, OneOf, isColorOrNone, isString, \
...
from HealthNet.static.reportlab.pdfbase.pdfmetrics import stringWidth, getAscentDescent
from HealthNet.static.reportlab.graphics.shapes import Drawing, Group, Circle, Rect, String, STATE_DEFAULTS
from HealthNet.static.reportlab.graphics.shapes import _PATH_OP_ARG_COUNT, _PATH_OP_NAMES, definePath
from HealthNet.static.reportlab.graphics.widgetbase import Widget, PropHolder
...
def _text2PathDescription(text, x=0, y=0, fontName=_baseGFontName, fontSize=1000,
    ...
    from HealthNet.static.reportlab.graphics import renderPM, _renderPM
...
from HealthNet.static.reportlab.graphics.charts.utils import CustomDrawChanger
