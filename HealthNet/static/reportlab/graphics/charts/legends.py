...
from HealthNet.static.reportlab.lib.validators import isNumber, OneOf, isString, isColorOrNone,\
...
from HealthNet.static.reportlab.graphics.shapes import Drawing, Group, String, Rect, Line, STATE_DEFAULTS
...
from HealthNet.static.reportlab.lib.utils import isSeq, find_locals
from HealthNet.static.reportlab.graphics.shapes import _baseGFontName
...
class TotalAnnotator(LegendColEndCallout):
    ...
    def __call__(self,legend, g, x, xt, y, width, lWidth):
        from HealthNet.static.reportlab.graphics.shapes import String, Line
        fontSize = self.fontSize
        fontName = self.fontName
        fillColor = self.fillColor
        strokeColor = self.strokeColor
...
class LineSwatch(Widget):
    ...
    def __init__(self):
        ...
        from HealthNet.static.reportlab.graphics.shapes import Line
        self.x = 0
        self.y = 0
        self.width  = 20
        self.height = 1
