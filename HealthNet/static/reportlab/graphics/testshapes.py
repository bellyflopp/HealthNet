...
from HealthNet.static.reportlab.graphics.renderPDF import _PDFRenderer
import unittest

_FONTS = ['Times-Roman','Vera','Times-BoldItalic',]

def _setup():
    from HealthNet.static.reportlab.pdfbase import pdfmetrics, ttfonts
...
from HealthNet.static.reportlab.graphics.widgets.signsandsymbols import SmileyFace
def getDrawing11():
    '''test of anchoring'''
