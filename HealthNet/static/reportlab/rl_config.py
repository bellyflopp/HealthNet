...
def _defaults_init():
    ...
    _DEFAULTS={}
    rl_exec('from HealthNet.static.reportlab.rl_settings import *',_DEFAULTS)

    _overrides=_DEFAULTS.copy()
    try:
        rl_exec('from HealthNet.static.reportlab.local_rl_settings import *',_overrides)
    ...
    _overrides=_DEFAULTS.copy()
    try:
        rl_exec('from HealthNet.static.reportlab_settings import *',_overrides)
        _DEFAULTS.update(_overrides)
    except ImportError:
        _overrides=_DEFAULTS.copy()
        try:
...
def _startUp():
    ...
    from HealthNet.static.reportlab.lib import pagesizes
    from HealthNet.static.reportlab.lib.utils import rl_isdir
    ...
    import HealthNet.static.reportlab as reportlab
