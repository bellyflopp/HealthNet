...
from HealthNet.static.reportlab.lib.utils import import_zlib, open_for_read, makeFileName, isSeq, isBytes, isUnicode, _digester, isStr, bytestr, isPy3, annotateException
from HealthNet.static.reportlab.lib.rl_accel import escapePDF, fp_str, asciiBase85Encode, asciiBase85Decode
...
class PDFStreamFilterZCompress:
    ...
    def encode(self, text):
        from HealthNet.static.reportlab.lib.utils import import_zlib
        zlib = import_zlib()
...
class PDFStreamFilterBase85Encode:
    ...
    def encode(self, text):
        from HealthNet.static.reportlab.pdfbase.pdfutils import _wrap
...
class PDFSeparationCMYKColor:
    def __init__(self, cmyk):
        from HealthNet.static.reportlab.lib.colors import CMYKColor
