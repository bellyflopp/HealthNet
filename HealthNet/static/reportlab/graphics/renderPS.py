...
from HealthNet.static.reportlab.pdfbase.pdfmetrics import getFont, stringWidth, unicode2T1 # for font info
from HealthNet.static.reportlab.lib.utils import getBytesIO, getStringIO, asBytes, char2int, rawBytes, asNative, isUnicode
from HealthNet.static.reportlab.lib.rl_accel import fp_str
from HealthNet.static.reportlab.lib.colors import black
from HealthNet.static.reportlab.graphics.renderbase import Renderer, StateTracker, getStateDelta, renderScaledDrawing
from HealthNet.static.reportlab.graphics.shapes import STATE_DEFAULTS
import math
...
''' % (self.width,self.height))
        ...
        if _f is not f:
            _f.close()
            from HealthNet.static.reportlab.lib.utils import markfilename
...
from HealthNet.static.reportlab.graphics.shapes import *
...
##              warnOnce('Fill opacity not done yet')
    ...
    def drawImage(self, image):
        from HealthNet.static.reportlab.lib.utils import ImageReader
...
def test(outDir='epsout',shout=False):
    ...
    from HealthNet.static.reportlab.rl_config import verbose
