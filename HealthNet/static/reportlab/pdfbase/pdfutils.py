...
from HealthNet.static.reportlab.lib.utils import getBytesIO, ImageReader, isUnicode, isPy3
from HealthNet.static.reportlab.lib.rl_accel import asciiBase85Encode, asciiBase85Decode
...
def readJPEGInfo(image):
    ...
    import struct
    from HealthNet.static.reportlab.pdfbase.pdfdoc import PDFError
