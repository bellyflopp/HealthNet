...
from HealthNet.static.reportlab.graphics.renderbase import StateTracker, getStateDelta, renderScaledDrawing
from HealthNet.static.reportlab.pdfbase.pdfmetrics import getFont, unicode2T1
from math import sin, cos, pi, ceil
from HealthNet.static.reportlab.lib.utils import getStringIO, getBytesIO, open_and_read, isUnicode
...
from HealthNet.static.reportlab.graphics.renderbase import Renderer
        ...
        for k in E:
            ...
            try:
                ...
                if os.path.isfile(fullpath):
                    os.remove(fullpath)
                if k=='pct':
                    from HealthNet.static.reportlab.lib.colors import white
