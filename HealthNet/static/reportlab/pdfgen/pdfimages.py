...
from HealthNet.static.reportlab.lib.utils import import_zlib, haveImages, getBytesIO, isStr
from HealthNet.static.reportlab.lib.rl_accel import fp_str, asciiBase85Encode
...
if __name__=='__main__':
    srcfile = os.path.join(
                os.path.dirname(HealthNet.static.reportlab.__file__),
                'test',
                'pythonpowered.gif'
                )
