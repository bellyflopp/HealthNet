...
from HealthNet.static.reportlab.lib.utils import ImageReader, isPy3, annotateException, encode_label, asUnicode, asBytes, uniChr, isStr
from HealthNet.static.reportlab.lib.colors import toColor, white, black, red, Color
from HealthNet.static.reportlab.lib.fonts import tt2ps, ps2tt
from HealthNet.static.reportlab.lib.enums import TA_LEFT, TA_RIGHT, TA_CENTER, TA_JUSTIFY
from HealthNet.static.reportlab.lib.units import inch,mm,cm,pica
if isPy3:
...
class ParaParser(HTMLParser):
    ...
    def _setup_for_parse(self,style):
        self._seq = HealthNet.static.reportlab.lib.sequencer.getSequencer()
...
if __name__=='__main__':
    from HealthNet.static.reportlab.platypus import cleanBlockQuotedText
