...
from HealthNet.static.reportlab.rl_config import shapeChecking, verbose, defaultGraphicsFontName as _baseGFontName, _unset_, decimalSymbol
from HealthNet.static.reportlab.lib import logger
from HealthNet.static.reportlab.lib import colors
from HealthNet.static.reportlab.lib.validators import *
from HealthNet.static.reportlab.lib.utils import isSeq, asBytes
...
class Group(Shape):
    ...
    def _explode(self):
        ...
        from HealthNet.static.reportlab.graphics.widgetbase import Widget
        obj = Group()
        if hasattr(obj,'transform'): obj.transform = self.transform[:]
...
class Drawing(Group, Flowable):
    ...
    def draw(self,showBoundary=_unset_):
        ...
        be used directly."""
        from HealthNet.static.reportlab.graphics import renderPDF
    ...
    def save(self, formats=None, verbose=None, fnRoot=None, outDir=None, title='', **kw):
        ...
        for bmFmt in ('gif','png','tif','jpg','tiff','pct','pict', 'bmp','tiffp','tiffl','tiff1'):
            if bmFmt in plotMode:
                from HealthNet.static.reportlab.graphics import renderPM
        ...
        if 'eps' in plotMode:
            try:
                ...
                from HealthNet.static.reportlab.graphics import renderPS
            filename = fnroot+'.eps'
        ...
        if 'svg' in plotMode:
            from HealthNet.static.reportlab.graphics import renderSVG
            filename = fnroot+'.svg'
