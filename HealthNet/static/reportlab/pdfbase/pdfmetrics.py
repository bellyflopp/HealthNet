...
from HealthNet.static.reportlab.pdfbase import _fontdata
from HealthNet.static.reportlab.lib.logger import warnOnce
from HealthNet.static.reportlab.lib.utils import rl_isfile, rl_glob, rl_isdir, open_and_read, open_and_readlines, findInPaths, isSeq, isStr, isUnicode, isPy3
from HealthNet.static.reportlab.rl_config import defaultEncoding, T1SearchPath
from HealthNet.static.reportlab.lib.rl_accel import unicode2T1, instanceStringWidthT1
from HealthNet.static.reportlab.pdfbase import rl_codecs
_notdefChar = b'n'
...
def bruteForceSearchForFile(fn,searchPath=None):
    if searchPath is None: from HealthNet.static.reportlab.rl_config import T1SearchPath as searchPath
...
def registerFontFamily(family,normal=None,bold=None,italic=None,boldItalic=None):
    from HealthNet.static.reportlab.lib import fonts
