...
import string
from HealthNet.static.reportlab.pdfbase.pdfdoc import PDFString, PDFStream, PDFDictionary, PDFName, PDFObject
from HealthNet.static.reportlab.lib.colors import obj_R_G_B
...
from HealthNet.static.reportlab.pdfbase.pdfpattern import PDFPattern, PDFPatternIf
...
class AcroForm(PDFObject):
    ...
    def format(self, document):
        from HealthNet.static.reportlab.pdfbase.pdfdoc import PDFArray
...
def FormFontsDictionary():
    from HealthNet.static.reportlab.pdfbase.pdfdoc import PDFDictionary
...
def FormFont(BaseFont, Name):
    from HealthNet.static.reportlab.pdfbase.pdfdoc import PDFName
...
def TextField(title, value, xmin, ymin, xmax, ymax, page,
    ...
    from HealthNet.static.reportlab.pdfbase.pdfdoc import PDFString, PDFName
    Flags = 0
    if multiline:
...
def SelectField(title, value, options, xmin, ymin, xmax, ymax, page,
    ...
    from HealthNet.static.reportlab.pdfbase.pdfdoc import PDFString, PDFName, PDFArray
