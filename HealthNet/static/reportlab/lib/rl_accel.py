...
for fn in __all__:
    try:
        exec('from HealthNet.static.reportlab.lib._rl_accel import %s as f' % fn)
        _c_funcs[fn] = f
...
if _py_funcs:
    from HealthNet.static.reportlab.lib.utils import isBytes, isUnicode, isSeq, isPy3, rawBytes, asNative, asUnicode, asBytes
