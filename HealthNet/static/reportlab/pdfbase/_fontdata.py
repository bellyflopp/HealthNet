...
from HealthNet.static.reportlab.rl_config import T1SearchPath
from HealthNet.static.reportlab.lib.utils import rl_isfile
...
from HealthNet.static.reportlab.pdfbase._fontdata_enc_winansi import WinAnsiEncoding
from HealthNet.static.reportlab.pdfbase._fontdata_enc_macroman import MacRomanEncoding
from HealthNet.static.reportlab.pdfbase._fontdata_enc_standard import StandardEncoding
from HealthNet.static.reportlab.pdfbase._fontdata_enc_symbol import SymbolEncoding
from HealthNet.static.reportlab.pdfbase._fontdata_enc_zapfdingbats import ZapfDingbatsEncoding
from HealthNet.static.reportlab.pdfbase._fontdata_enc_pdfdoc import PDFDocEncoding
from HealthNet.static.reportlab.pdfbase._fontdata_enc_macexpert import MacExpertEncoding
encodings.update({
...
import HealthNet.static.reportlab.pdfbase._fontdata_widths_courier
import HealthNet.static.reportlab.pdfbase._fontdata_widths_courierbold
import HealthNet.static.reportlab.pdfbase._fontdata_widths_courieroblique
import HealthNet.static.reportlab.pdfbase._fontdata_widths_courierboldoblique
import HealthNet.static.reportlab.pdfbase._fontdata_widths_helvetica
import HealthNet.static.reportlab.pdfbase._fontdata_widths_helveticabold
import HealthNet.static.reportlab.pdfbase._fontdata_widths_helveticaoblique
import HealthNet.static.reportlab.pdfbase._fontdata_widths_helveticaboldoblique
import HealthNet.static.reportlab.pdfbase._fontdata_widths_timesroman
import HealthNet.static.reportlab.pdfbase._fontdata_widths_timesbold
import HealthNet.static.reportlab.pdfbase._fontdata_widths_timesitalic
import HealthNet.static.reportlab.pdfbase._fontdata_widths_timesbolditalic
import HealthNet.static.reportlab.pdfbase._fontdata_widths_symbol
import HealthNet.static.reportlab.pdfbase._fontdata_widths_zapfdingbats
widthsByFontGlyph = {
    'Courier':
    HealthNet.static.reportlab.pdfbase._fontdata_widths_courier.widths,
    'Courier-Bold':
    HealthNet.static.reportlab.pdfbase._fontdata_widths_courierbold.widths,
    'Courier-Oblique':
    HealthNet.static.reportlab.pdfbase._fontdata_widths_courieroblique.widths,
    'Courier-BoldOblique':
    HealthNet.static.reportlab.pdfbase._fontdata_widths_courierboldoblique.widths,
    'Helvetica':
    HealthNet.static.reportlab.pdfbase._fontdata_widths_helvetica.widths,
    'Helvetica-Bold':
    HealthNet.static.reportlab.pdfbase._fontdata_widths_helveticabold.widths,
    'Helvetica-Oblique':
    HealthNet.static.reportlab.pdfbase._fontdata_widths_helveticaoblique.widths,
    'Helvetica-BoldOblique':
    HealthNet.static.reportlab.pdfbase._fontdata_widths_helveticaboldoblique.widths,
    'Times-Roman':
    HealthNet.static.reportlab.pdfbase._fontdata_widths_timesroman.widths,
    'Times-Bold':
    HealthNet.static.reportlab.pdfbase._fontdata_widths_timesbold.widths,
    'Times-Italic':
    HealthNet.static.reportlab.pdfbase._fontdata_widths_timesitalic.widths,
    'Times-BoldItalic':
    HealthNet.static.reportlab.pdfbase._fontdata_widths_timesbolditalic.widths,
    'Symbol':
    HealthNet.static.reportlab.pdfbase._fontdata_widths_symbol.widths,
    'ZapfDingbats':
    HealthNet.static.reportlab.pdfbase._fontdata_widths_zapfdingbats.widths,
}
...
from HealthNet.static.reportlab.rl_config import register_reset
